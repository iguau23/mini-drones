...
def linear(mc):
    time.sleep(1)
    mc.forward(1.5, velocity=0.6)
    time.sleep(1)

def arco(mc):
    time.sleep(1)
    mc.turn_right(90)
    mc.circle_left(0.75, velocity=0.5, angle_degrees=180)
    mc.turn_right(90)
    time.sleep(1)

def zigueZague(mc):
    time.sleep(1)
    mc.move_distance(0.4, 0.25, 0, velocity=0.4)
    time.sleep(1)
    mc.move_distance(0.7, -0.5, 0, velocity=0.4)
    time.sleep(1)
    mc.move_distance(0.4, 0.25, 0, velocity=0.4)
    time.sleep(1)
